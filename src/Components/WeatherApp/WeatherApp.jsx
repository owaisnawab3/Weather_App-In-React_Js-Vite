...
function WeatherApp() {
    ...
    let api_key = '60fed9618dade751d2962479989d9af2';
    ...
    let tempreture = document.getElementsByClassName('weather_temp')
    let location = document.getElementsByClassName('weather_location')


    humidity[0].innerHTML = data.main.humidity + '%'
    wind[0].innerHTML = Math.floor(data.wind.speed) + ' km/h'
    tempreture[0].innerHTML = Math.floor(((data.main.temp) - 273.15).toFixed(2)) + '° C'
  ...
  return (
    ...
    <div className='top-bar'>
     ...
     <div className='serach_icon' onClick={()=>{search()}}>
